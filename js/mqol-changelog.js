const mqolChangelog = [
    ...
    },
    {
        b: "259", te: "Update 1.2.3 - Played Time Tab Fixes", tp: "Aktualizacja 1.2.3 - Poprawki zakładki Played Time", c: [
            ...
            { t: "Fixed", e: "Fixed class names not rendering properly on the Pie Chart.", p: "Naprawiono problem z niewyświetlaniem nazw klas na wykresie kołowym (Pie Chart)." }
        ]
    },
    {
        b: "258", te: "Update 1.2.3 - Played Time Tab", tp: "Aktualizacja 1.2.3 - Zakładka Played Time", c: [
            { t: "Added", e: "Added a new 'Played Time' tab to the Account Overview.", p: "Dodano nową zakładkę 'Played Time' w Przeglądzie Konta." },
            { t: "Added", e: "Added the ability to inspect time played per class using three distinct views: Horizontal, Column, and Pie.", p: "Dodano możliwość sprawdzenia czasu gry poszczególnymi klasami za pomocą trzech widoków: poziomego (Horizontal), kolumnowego (Column) oraz kołowego (Pie)." }
        ]
    },
    {
        b: "257", te: "Update 1.2.3 - Sorting", tp: "Aktualizacja 1.2.3 - Sortowanie postaci", c: [
            { t: "Added", e: "Added character sorting in the Account Overview by name, level, Vault, played time, and gold.", p: "Dodano sortowanie postaci w Przeglądzie Konta po nazwie, poziomie, skarbcu (Vault), czasie gry oraz złocie." },
            { t: "Changed", e: "Character sorting now functions independently for favorite and non-favorite characters.", p: "Sortowanie postaci działa osobno dla postaci ulubionych i nieoznaczonych jako ulubione." }
        ]
    },
    {
        b: "256", te: "Update 1.2.3 - Secondary Professions Details", tp: "Aktualizacja 1.2.3 - Szczegóły profesji pobocznych", c: [
            { t: "Added", e: "Added an improved details panel for secondary professions that generates a separate table for each profession.", p: "Dodano ulepszony panel szczegółów dla profesji pobocznych, który tworzy osobną tabelę dla każdej z nich." }
        ]
    },
    {
        b: "255", te: "Update 1.2.3 - Secondary Professions Tooltip", tp: "Aktualizacja 1.2.3 - Tooltip profesji pobocznych", c: [
            { t: "Removed", e: "Removed the display of secondary profession names in the tooltip.", p: "Usunięto wyświetlanie nazw profesji pobocznych w tooltipie." },
            { t: "Changed", e: "Categorized the profession list layout inside the tooltip.", p: "Podzielono wyświetlanie profesji na kategorie w tooltipie." },
            { t: "Added", e: "Added a spacing gap between the general info and the first profession in the tooltip.", p: "Dodano przerwę pomiędzy ogólną informacją a pierwszą profesją w tooltipie." }
        ]
    },
    {
        b: "254", te: "Update 1.2.3 - Fix Dungeon Teleports Tab Event", tp: "Aktualizacja 1.2.3 - Poprawka zdarzeń w zakładce Dungeon Teleports", c: [
            { t: "Removed", e: "Removed the 'invited' event that was mistakenly left over from testing.", p: "Usunięto błędnie pozostawione zdarzenie (event) 'invited' z fazy testów." }
        ]
    },
    {
        b: "253", te: "Update 1.2.3 - Account Overview Secondary Professions", tp: "Aktualizacja 1.2.3 - Profesje poboczne w Account Overview", c: [
            { t: "Added", e: "Added display of secondary professions (Cooking, Fishing, etc.).", p: "Dodano wyświetlanie profesji pobocznych (Cooking, Fishing itp.)." },
            { t: "Fixed", e: "Fixed the profession saving logic to prevent saving non-profession skills (e.g., Raiding Skill).", p: "Naprawiono kod zapisujący profesje, aby nie zapisywał umiejętności niebędących profesjami (np. Raiding Skill)." }
        ]
    },
    {
        b: "252", te: "Update 1.2.3 - Account Overview Favorites", tp: "Aktualizacja 1.2.3 - Ulubione postacie w Account Overview", c: [
            { t: "Added", e: "Added the ability to mark characters as favorites, keeping them at the very top of the list.", p: "Dodano możliwość oznaczenia postaci jako ulubionej, dzięki czemu zawsze będzie na samej górze." }
        ]
    },
    {
        b: "251", te: "Update 1.2.3 - Account Overview Changes", tp: "Aktualizacja 1.2.3 - Zmiany w Account Overview", c: [
            { t: "Added", e: "Added a new tile for secondary professions (Cooking, Fishing, etc.).", p: "Dodano nowy kafelek dla profesji pobocznych (Cooking, Fishing itp.)." },
            { t: "Changed", e: "Adjusted the table layout to ensure all elements fit correctly.", p: "Poprawiono układ tabeli, aby wszystkie elementy się mieściły." }
        ]
    },
    {
